<template>
  <the-form-group>
    ...
    <v-select label="担当科目（小学校）" chips append-outer-icon="mdi-lead-pencil" />
    <v-select label="担当科目（中学校）" chips append-outer-icon="mdi-lead-pencil" />
    <v-select label="担当科目（高校）" chips append-outer-icon="mdi-lead-pencil" />
  </the-form-group>
</template>
